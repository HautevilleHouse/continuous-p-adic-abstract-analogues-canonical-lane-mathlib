...
structure PAdicFormalizationCertificate where
  sourceRepo : String
...
def formalizationCertificate : PAdicFormalizationCertificate := {
  sourceRepo := "continuous-p-adic-abstract-analogues-canonical-lane",
